...
# 读取两个结果文件
dp_iters, dp_losses, dp_accs = read_csv("dp-mnist_79999round.csv")
normal_iters, normal_losses, normal_accs = read_csv("mnist_79999round.csv")
...
plt.legend()
plt.grid(True)
plt.savefig("mnist_dp-normal_acc.png")
...
plt.legend()
plt.grid(True)
plt.savefig("mnist_dp-normal_loss.png")
